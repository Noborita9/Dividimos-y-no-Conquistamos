...
\subsection{Bash CMD}
\bashfile{src/Details/cmd_setup.sh}
\subsection{C++ Int128}
\cppfile{src/Details/Int128.cpp}
\subsection{C++ RNG}
\cppfile{src/Details/RNG.cpp}
\subsection{Python Template}
\pyfile{src/Details/template.py}
% \subsection{Java Template}
% \javafile{src/Details/template.java}
...
\cppfile{src/DataStructure/SegmentTreePersistente.cpp}
\subsection{Policy Based}
\cppfile{src/DataStructure/policy_based.cpp}
% \subsection{SQRT Decomposition}
% \cppfile{src/DataStructure/SQRTDecomp.cpp}
\subsection{Chull Trick}
\cppfile{src/DataStructure/ChullTrick.cpp}
...
\subsection{Directed MST/Arborescence}
\cppfile{src/Graph/DirectedMST.cpp}
...
\cppfile{src/String/SuffixAutomaton.cpp}
...
\subsection{Get Divisors}
\cppfile{src/Math/GetDivisors.cpp}
\subsection{Simpson}
\cppfile{src/Math/SIMPSON.cpp}
\subsection{Simplex}
\cppfile{src/Math/SIMPLEX.cpp}

\section{Geometry}
\subsection{Point Definition}
\cppfile{src/Geometry/Point.cpp}
...
\cppfile{src/Other/Mo.cpp}

\section{Ecuations}
\subsection{Combinatorics}
\input{src/MathFormulas/Combinatorias.tex}
\subsection{Discreta}
\input{src/MathFormulas/Discreta.tex}
\subsection{Trigonometry}
\input{src/MathFormulas/Trigonometry.tex}
\subsection{Catalan Numbers}
\input{src/MathFormulas/CatalanNumbers.tex}
\subsection{Geometry}
\input{src/MathFormulas/GeometryAreas.tex}
\subsection{Useful math}
\input{src/MathFormulas/UsefulMath.tex}
\subsection{Mobius}
\input{src/MathFormulas/Mobius.tex}
\subsection{Burnside}
\input{src/MathFormulas/Burnside.tex}
