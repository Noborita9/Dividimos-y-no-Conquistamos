...
\begin{document}
% Gracias Demetrio
\def\title{ORT Uruguay, Dividimos y No Conquistamos}
.\\[0.2cm]
...
\subsection{Divide and Conquer Opt}
\cppfile{src/DP/DnCopt.cpp}
\subsection{Knuth Opt}
\cppfile{src/DP/KnuthOpt.cpp}
